-- Load people.csv into the people landing table
...
COPY INTO crunchbase_raw.raw.people
...
FROM (
    ...
    FROM @crunchbase_raw.ingestion.crunchbase_s3_stage/people/
)
...
SELECT 'crunchbase_raw.raw.people', "file", "rows_parsed", "rows_loaded",
