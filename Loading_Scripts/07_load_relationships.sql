-- Load relationships.csv into the relationships landing table
...
COPY INTO crunchbase_raw.raw.relationships
    (id, relationship_id, person_object_id, relationship_object_id, start_at, end_at,
     is_past, sequence, title, created_at, updated_at,
...
FROM (
    ...
    FROM @crunchbase_raw.ingestion.crunchbase_s3_stage/relationships/
)
...
SELECT 'crunchbase_raw.raw.relationships', "file", "rows_parsed", "rows_loaded",
