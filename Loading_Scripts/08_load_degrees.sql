-- Load degrees.csv into the degrees landing table
...
COPY INTO crunchbase_raw.raw.degrees
...
FROM (
    ...
    FROM @crunchbase_raw.ingestion.crunchbase_s3_stage/degrees/
)
...
SELECT 'crunchbase_raw.raw.degrees', "file", "rows_parsed", "rows_loaded",
